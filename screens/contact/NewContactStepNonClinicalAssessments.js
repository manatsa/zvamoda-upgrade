...
export default function NewContactStepNonClinicalAssessments({
  initValues,
  validationSchema,
  onNextStep,
  onBack,
  ...
  const nonClinicAssessment = assessments
    .filter((s) => s.contactAssessment === "Non Clinical")
    .map((s) => {
  ...
  return (
    ...
    >
      <AppFormCheckBox
        name={"nonClinicalAssessments"}
        items={nonClinicAssessment}
        label={"Non Clinical Assessments"}
      />
